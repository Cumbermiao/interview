...
let excludeFunc = ['unsafeCastStringToDOMTopLevelType','prefixKey','PropertyInfoRecord','publishRegistrationName','publishEventForPlugin']
if(excludeFunc.indexOf(%%FUNC_NAME%%)==-1){
  console.log(%%FUNC_NAME%%,arguments.length>0?arguments:null)
}
%%BODY%%
`)
